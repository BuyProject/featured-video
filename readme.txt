...
1. A Featured Video in the Twenty Fifteen theme on [buycloud.id](https://buycloud.id/wordpress/featuredvideo).
...
Yes, please! Check out the official [Featured Video Translation Project](https://translate.wordpress.org/projects/wp-plugins/featuredvideo).
